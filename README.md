...
Kun Data provides real-time market data for Argentina through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Argentina market coverage with support for BYMA.

## API Capabilities

- Real-time WebSocket market data for Argentina
...
This repository is designed to make Argentina market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/argentina-stock-market-api
