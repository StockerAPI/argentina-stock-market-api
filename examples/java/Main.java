...
public class Main {
    ...
    private static final String MARKET = "AR";
    private static final String EXCHANGE = "BYMA";
    private static final String SYMBOL = "BYMA:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"BYMA:000040\",\"BYMA:005930\"],\"replay\":\"last\"}";
